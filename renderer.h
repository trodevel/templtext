...
// $Revision: 2281 $ $Date:: 2015-08-07 #$ $Author: serge $
...
{
public:
    Renderer( const Templ::Elems & elems, const Templ::MapKeyValue & tokens, const Templ::FuncProc & func_proc, bool throw_on_error );
...
private:
    ...
    const Templ::FuncProc           & func_proc_;
